...
public class Validation
{
    ...
    internal class InputValidation
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(input) || !Regex.Match(input, AgePattern).Success) return false;
        ...
        {
            if (string.IsNullOrWhiteSpace(input) || !Regex.Match(input, GuidPattern).Success) return false;
