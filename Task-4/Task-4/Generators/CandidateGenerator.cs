...
{
    private static readonly Random RandomAmountToGenerate = new();
    ...
    public static Candidate GenerateCandidate()
    {
        var candidate = new Faker<Candidate>().CustomInstantiator(f => new Candidate())
            ...
            .RuleFor(c => c.DesiredSalary, (f, c) => f.Finance.Amount(
    ...
    public static List<IUser> GenerateAFewCandidates()
    {
        var candidatesList = new List<IUser>();
